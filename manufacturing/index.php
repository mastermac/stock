...
<body>
	...
	<div class="container-fluid text-center">
		...
		<div class="btn-group mb-4 mt-4" role="group" aria-label="Basic example">
			<button type="button" class="btn btn-outline-deep-purple btn-rounded waves-effect" data-toggle="modal" onclick="AddMoreRows()">Add Empty Rows</button>
			<button type="button" class="btn btn-outline-deep-purple btn-rounded waves-effect" data-toggle="modal" onclick="uploadData()">Save</button>
			<button type="button" class="btn btn-outline-deep-purple btn-rounded waves-effect" data-toggle="modal" onclick="moveToInvoice()">Invoice</button>
		</div>

		<!--Table-->
		<div id="manufacturingInventory" class="ag-theme-alpine mx-auto" style="width: 100%;text-align:left!important;"></div>
		<!--Table-->
	</div>
	...
	<div class="modal fade" id="invoiceModal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
