...
$sql = "UPDATE product SET comments='".$post['edit_comments']."', itemNo='" . $post['edit_itemId'] . "', vendor='" . strtoupper($post['edit_vendor']) . "', 
      ...
      styleCode='" . clean($post['edit_styleCode']) . "', mu='".$post['edit_mu']."', costPrice='".$post['edit_costPrice']."', dimensions='".$post['edit_dimensions']."', vendorPO='".$post['edit_vendorPO']."', brand='".$post['edit_brand']."', goldPrice='".$post['edit_goldPrice']."', silverPrice='".$post['edit_silverPrice']."' where itemNo='" . $post['edit_id'] . "' ".$usertype;
