...
var stoneInventory = {
	columnDefs: [
		...
		{ headerName: "C Qty", field: "current_qty", filter: "agNumberColumnFilter", cellClass: 'current-row' },
		{ headerName: "C Wt", field: "current_wt", filter: "agNumberColumnFilter", cellClass: 'current-row' },
		...
		{ headerName: "Cur Value", field: "current_value", width: 130, filter: "agNumberColumnFilter", cellClass: 'current-row' },
