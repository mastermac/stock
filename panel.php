...
<html>
  <head>
    ...
    <style>
      .productTable tr td:nth-child(1), .productTable tr th:nth-child(1) {width:30px;}
      .productTable tr td:nth-child(2), .productTable tr th:nth-child(2) {width:120px;}
      .productTable tr td:nth-child(3), .productTable tr th:nth-child(3) {width:70px;}
      .productTable tr td:nth-child(4), .productTable tr th:nth-child(4) {width:90px;}
      .productTable tr td:nth-child(5), .productTable tr th:nth-child(5) {width:85px;}
      .productTable tr td:nth-child(6), .productTable tr th:nth-child(6) {width:250px;}
      .productTable tr td:nth-child(7), .productTable tr th:nth-child(7) {width:240px;}
      .productTable tr td:nth-child(8), .productTable tr th:nth-child(8) {width:70px;}
      .productTable tr td:nth-child(9), .productTable tr th:nth-child(9) {width:80px;}
      .productTable tr td:nth-child(10), .productTable tr th:nth-child(10) {width:90px;}
      .productTable tr td:nth-child(11), .productTable tr th:nth-child(11) {width:90px;}
      .productTable tr td:nth-child(12), .productTable tr th:nth-child(12) {width:70px;}
      .productTable tr td:nth-child(13), .productTable tr th:nth-child(13) {width:70px;}
    ...
    <div class="container-fluid">
      ...
      <div >
        ...
        <div class="form-group col-md-1" style="min-width: 5%;max-width: 5%;padding-left: 5px;padding-right: 15px;">
          ...
          <button class="btn btn-xs btn-outline-danger reset-item" id="resetFilter" name="resetFilter">RESET</button>
        </div>
      </div>
      </form>
      </div>
...
$(window).on('load', function () {
  ...
  if($_SESSION["msg"]==1){
    ?>
    <script>
                toastr.success('You are successfully logged in!', 'Welcome :)', {timeOut: 5000, closeButton: true});
</script>
<?php 
$_SESSION["msg"]=0;
  }
